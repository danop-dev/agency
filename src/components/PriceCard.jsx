        ...
        <Fragment>
            {pricesData.map(item => (
                <div key={item.id} className="pricing-card">
                    ...
                    <div className="h4-subtitle">{item.subtitle}</div>
                    ...
                    {item.type === "popular" ? <Button type={"primaryOrange"} name="Contact Us" /> : <Button type={"secondaryTransparent"} name="Contact Us" />}
                </div>
            ))}
        </Fragment>
    )
